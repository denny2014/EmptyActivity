...
public class RSSHandler2 extends DefaultHandler {
	...
	private static final int ATTACH = 27;
...
//		mAttach = new ATTACH();
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		node = qName;
		flag = true;
		if(qName.equals("ATTACHS")){
			System.out.println("endElement attachs");
		}
		sb = new StringBuilder();
		if (localName.equals("WORK")) {
			currentstate = 0;
			currentParent = "WORK";
		} else if (localName.equals("ADMDIV_CODE") && currentParent.equals("WORK")) {
			...
			currentstate = TITLE;
		} else if (localName.equals("REPORT_DATE") && currentParent.equals("WORK")) {
